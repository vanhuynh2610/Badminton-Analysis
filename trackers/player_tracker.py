...
class PlayerTracker:
    ...
    def choose_player(self, court_keypoints, player_dict):
        ...
        for track_id, bbox in player_dict.items():
            ...
            for i in range(0,len(court_keypoints)-1,2):
        ...
        chosen__players = [distances[0][0] ,distances[1][0]]
        return chosen__players
    ...
    def draw_bboxes(self, video_frames, player_detections):
        ...
        for frame, player_dict in zip(video_frames , player_detections):
            for track_id , bbox in player_dict.items():
                ...
                cv2.putText(frame, f"Player ID: {track_id}",(int(bbox[0]),int(bbox[1] -10)), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 0, 225), 2)
